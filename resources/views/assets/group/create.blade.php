        ...
        <form method="POST" action="{{route('group.store')}}">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-5">
                    <label for="group Code">Group Code</label> <small class="text-muted">( It has to be unique )</small>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="max-member">Max Member</label> <small class="text-muted">( By default its 5 )</small>
