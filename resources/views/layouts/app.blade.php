...
<body>
    <div id="app">
        ...
        @auth
        <div class="_container mx-2 my-2">
            <div class="row">
                <div class="col-3 _option">
